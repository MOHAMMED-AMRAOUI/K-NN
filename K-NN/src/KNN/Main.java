...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String path= sc.getUrl2();
        String chemin ="weather.nominal.arff";  // chemin du corpus
        
        FileToList fichier=new FileToList(chemin);
        Distances distances=new Distances();
        List<Instance> listeInstances = fichier.lireFichier();
        //La méthode shuffle() est une méthode de classe Java Collections qui fonctionne
            // en permutant au hasard les éléments de liste spécifiés
            // ici en permutant au hasard la liste d'instance "listeInstances".
        ...
        // Size de corpus d'apprentissage et de Test
        ...
        for(i=0;i<listTest.size();i++){
            ...
            String resultat=distances.classeInstance(listeResultats,3);
